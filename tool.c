...
// remove all negs from cn (by resetting exp to exp used), returning amount removed
double deneg_character(int cn)
{
	double negs = 0.0;
	double neg = 0.0;
	...
	if (ch[cn].exp >= ch[cn].exp_used) return 0;

	neg = ch[cn].exp_used*.001;
	negs = (ch[cn].exp_used - ch[cn].exp)/neg;
...
{
    double hardcore_bonus = 0;
    double donor_bonus = 0;
	double exppot_bonus = 0;
	
	int lbonus,lval,n,in;
	double lmath,clan_bonus;


    //log_char(cn,LOG_SYSTEM,0,"You gained %d exp.",val);
	if (areaID==21 || areaID == 30) return;	// !!!!!!!!!!!!!!!!! hack !!!!!!!!!!!!!!!
    if (ch[cn].flags&CF_NOEXP) return;
	
	lbonus=get_clan_bonus(get_char_clan(cn),3);
	lmath=lbonus*15;
	clan_bonus = lmath/1000;
    lval=val + floor(val*clan_bonus);
	val += lval;
	

    if (ch[cn].flags&CF_HARDCORE)
        val = val*1.10;  //hardcore bonus (10% extra)
	if (ch[cn].flags&CF_DONOR)
		val = val*1.10; 	//donor bonus (10% extra)
	for (n=12; n<30; n++) {
		if ((in=ch[cn].item[n]) && it[in].driver==IDR_EXPBONUS) {
			 val=val*1.05;
		}
		if ((in=ch[cn].item[n]) && it[in].driver==IDR_TOKENEXPBONUS) {
			val=val*1.10;
		}
	}
		...
		if ((v=in->mod_value[n]) && (s=in->mod_index[n])>-1) {
			...
			if (in->driver==IDR_DECAYITEM) {
				...
				if (ch[cn].flags&CF_GOD) {
					if (s==V_ARMOR){ 
                        log_char(cn,LOG_SYSTEM,0,"%s %+.2f °c1(%d: %d+%d)",skill[s].name,v/20.0,n,s,v);
                    }
...
char *get_title(int co)
{
	...
	lppd=set_data(co,DRD_LOSTCON_PPD,sizeof(struct lostcon_ppd));
    int tval = lppd->titlevalue;
    
	//Check if title is on
	if (ch[co].flags&CF_TITLE) {
        switch(tval) {
            ...
            case 3:  return "Dark ";
            case 4:  return "Darth ";
            case 5:  return "Dimwit ";
            case 6:  return "Drunken ";
            case 7:  return "Evil ";
            case 8:  return "Good ";
            case 9:  return "Great ";
            case 10: return "Holy ";
            case 11: return "Jedi ";
            case 12: return "Maester ";
            case 13: return "Magic ";
            case 14: return "Miss ";
            case 15: return "Mrs. ";
            case 16: return "Mr. ";
            case 17: return "Mother ";
            case 18: return "Father "; 
            case 19: return "MVP ";
            case 20: return "Ninja ";
            case 21: return "Noob ";
            case 22: return "Pirate ";
            case 23: return "Psycho ";
            case 24: return "Queen ";
            case 25: return "King ";  
            case 26: return "Ranger ";
            case 27: return "Super ";
            case 28: return "Sweet ";
            case 29: return "Unicorn ";
            
            //Profession Titles
            case 30: return "Speedy ";
            case 31: return "Shaker ";
            case 32: return "Miner ";
            case 33: return "Sneaky ";
            case 34: return "Thief ";
            case 35: return "Gladiator ";
            case 36: return "Trader ";
            case 37: return "Hired Gun ";
            case 38: return "Gardener ";
            case 39: return "Dr. ";
            case 40: return "Prof. ";
            //Military rank titles
            case 41: return  "Private ";
            case 42: return  "PFC ";
            case 43: return  "LCpl ";
            case 44: return  "Cpl ";
            case 45: return  "Sgt ";
            ...
            case 51: return  "1Lt ";
            case 52: return  "Cpt ";
            case 53: return  "Major ";
            case 54: return  "LtCol ";
            case 55: return  "Col ";
            case 56: return  "BG ";
            case 57: return  "MG ";
            case 58: return  "LG ";
            case 59: return  "General ";
            case 60: return  "FM ";
            case 61: return  "Knight ";
            case 62: return  "Baron ";
            case 63: return  "Earl ";
            case 64: return  "Warlord ";
            case 65: if (ch[co].flags&CF_FEMALE) return "Lady "; else return "Sir ";
            case 66: return "Tutor ";
            case 67: return "Staffer ";
            case 68: return "God ";
            //Achievement  Titles (for things like deathless and quests)
            case 69: return "Immortal ";
            case 70: return "Zombie ";
            case 71: return "RIP ";
            case 72: return "Phantom ";
            case 73: return "Moneybags ";
            //clan related
            case 74: return "Kingpin ";
            //Quest related
            case 75: return "Hunter ";
            case 76: return "Undead ";
            case 77: return "Yummy ";
            case 78: return "Snitch ";
            case 79: return "Mafia ";
            case 80: return "Dragonborn ";
            case 81: return "Invader ";
            case 82: return "Amazing ";
            case 83: return "Legendary ";
            //Time played related
            case 84: return "Novice ";
            case 85: return "Master ";
            case 86: return "Elder ";
            case 87: return "Ancient ";
            //Level related
            case 88: return "Rugged ";
            case 89: return "Hero ";
            case 90: return "Allstar ";
            //Hardcore
            case 91: return "Insane ";
...
struct special_item special_item[]={
    ...
    {"Endurance",		{V_ENDURANCE,-1,-1},	    SP_SOME,	0,		0,	1},
...
int create_special_item(int strength,int base,int potionprob,int maxchance)
{
    ...
    /*
        ...
        */
    if (strength <= 5) strength = 1+RANDOM(strength);
	else if (strength <= 9) strength = (strength-4)+RANDOM(5);
    else strength=strength-4+lowhi_random(4);
    ...
    //Dusan: adding rarity color to item names
    int chance_num;
    //Get the rarity of item and store as a number between 1 - 6
    switch(special_item[nr].chance){
        case SP_LOTS: chance_num = 0;   break;
        case SP_MANY: chance_num = 1;   break;
        case SP_SOME: chance_num = 2;   break;
        case SP_FEW: chance_num = 3;    break;
        case SP_RARE: chance_num = 4;   break;
        case SP_ULTRA: chance_num = 5;  break;
        default: chance_num = 0;    break;
    }
    //Chance color stores the color value for chat
    int chance_color[6];
    chance_color[0]= 0;  //Lots color
    chance_color[1]= 1;  //Many color
    chance_color[2]= 2;  //Some color
    chance_color[3]= 7;  //Few color
    chance_color[4]= 16; //Rare color
    chance_color[5]= 12; //Ultra color
    
	if (nr==ARRAYSIZE(special_item)) { elog("create_special_item(): dice wrong"); return 0; }

        len=snprintf(buf,sizeof(it[0].description)-1,"°c%d%s of %s%s%s.",
             chance_color[chance_num],
		     it[in].name,
...
{    
	...
	//Dusan added military exp bonus for HC chars
    if (ch[cn].flags&CF_HARDCORE)
        exps = exps*1.10;  //hardcore bonus (10% extra)
...
int create_orb(void)
{
	int in;
	int r,what;
    int img = 51086;//generic orb sprite
	...
	switch(r) {
		        case 0:		what=V_ENDURANCE; img=56915; break;
                case 1:		what=V_HP;img=56914; break;
                case 2:		what=V_MANA; img=56916; break;
                case 3:		what=V_WIS; img=56917; break;
                case 4:		what=V_INT; img=56918; break;
                case 5:		what=V_AGI; img=56919; break;
                case 6:		what=V_STR; img=56920; break;
                case 7:		what=V_PERCEPT; img=56933; break;
                case 8:		what=V_STEALTH; img=56934; break;
                case 9:	    what=V_HAND; img=56922; break;
                case 10:	what=V_WARCRY; img=56928; break;
                case 11:	what=V_SURROUND;img=56930; break;
                case 12:	what=V_BODYCONTROL; img=56945;break;
                case 13:	what=V_SPEEDSKILL; img=56931; break;
                case 14:	what=V_FIREBALL; img=56940; break;
                case 15:	what=V_TACTICS; img=56929; break;
		        case 16:	what=V_DURATION; img=56942; break;
		        case 17:	what=V_RAGE; img=56943; break;
		        case 18:	what=V_BLESS; img=56935; break;
		        case 19:	what=V_FREEZE; img=56937; break;
		        case 20:	what=V_MAGICSHIELD;img=56938; break;
		        case 21:	what=V_FLASH; img=56939; break;
		        case 22:	what=V_PULSE; img=56944; break;
                case 23:	what=V_DAGGER; img=56921; break;
                case 24:	what=V_STAFF; img=56923; break;
		        case 25:	what=V_SWORD;img=56924; break;
		        case 26:	what=V_TWOHAND; img=56925; break;
                case 27:	what=V_ATTACK;  img=56926; break;
                case 28:	what=V_PARRY;img=56927; break;
		        case 29:	what=V_IMMUNITY; img=56941; break;
	...
	int co;
        ...
        for (co=getfirst_char(); co; co=getnext_char(co)) {
            ...
            if(ch[co].flags&(CF_GOD)) {
                tell_chat(0,cnID,1,"God: %s (%s)%s",
                      ch[co].name,
                      ch[co].staff_code,
                      ch[co].driver==0 ? "" : " - (lagging)");
            }else{
                tell_chat(0,cnID,1,"Staffer: %s (%s)%s",
                      ch[co].name,
                      ch[co].staff_code,
                      ch[co].driver==0 ? "" : " - (lagging)");
            }
...
void do_whotutor(int cnID)
{
	int co;
        ...
        for (co=getfirst_char(); co; co=getnext_char(co)) {
            if (ch[co].flags&CF_INVISIBLE) continue;
            if (!(ch[co].flags&CF_PLAYER)) continue;
            if (!(ch[co].flags&(CF_STAFF|CF_GOD|CF_TUTOR))) continue;
            
            if(ch[co].flags&(CF_GOD)) {
                tell_chat(0,cnID,1,"God: %s %s",
                      ch[co].name,
                      ch[co].driver==0 ? "" : "- (lagging)");
            }
            else if(ch[co].flags&(CF_STAFF)){
                tell_chat(0,cnID,1,"Staffer: %s %s",
                      ch[co].name,
                      ch[co].driver==0 ? "" : "- (lagging)");
            }else{
                tell_chat(0,cnID,1,"Tutor: %s %s",
                      ch[co].name,
                      ch[co].driver==0 ? "" : "- (lagging)");                
...
void sanitize_item(struct item *in,int cn)
{
	...
	if (cnt>3) {
		in->min_level=250;
		strcpy(in->description,"This item is locked (4/5stat). Please contact game@astoniareborn3.com.");
...
// give enough exp to character to return it to beginning of its ingame level
// returns exp given


//Dusan: When player logs in, clan is informed.
void clan_plyr_login(int cn, int login_flag){
    int channel = 7;
    int xID;
    char buf[256];
    if (ch[cn].flags&(CF_STAFF|CF_GOD)) xID=0;
	else xID=ch[cn].ID;
    if(!(get_char_clan(cn))) return;
    if(ch[cn].flags&CF_NOWHO || ch[cn].flags&CF_INVISIBLE)
        return;
        
    if(login_flag == 1){
        sprintf(buf,"%010u:%02u:°c%dClan2: °c%d%s (%d)°c%d has come °c2online!",
            xID,
            get_char_clan(cn),
            16, //internal clan color
            2,  //turn name green
            ch[cn].name,
            ch[cn].clan_rank,
            16);		// clan internal color
    }
    else if (login_flag == 0){
        sprintf(buf,"%010u:%02u:°c%dClan2: °c%d%s (%d)°c%d is now °c3offline.",
            xID,
            get_char_clan(cn),
            16, //internal clan color
            3,  //turn name red
	...
	server_chat(channel,buf);
}

//Dusan: When player logs in, clan is informed.
void clan_plyr_join(int cn, int join_flag){
    int channel = 7;
    int xID;
    char buf[256];
    if (ch[cn].flags&(CF_STAFF|CF_GOD)) xID=0;
    ...
    if(join_flag == 1){
        sprintf(buf,"%010u:%02u:°c%dClan2: °c%d%s°c%d has °c2joined°c16 the clan!",
            xID,
            get_char_clan(cn),
            16, //internal clan color
            2,  //turn name green
        ...
        sprintf(buf,"%010u:%02u:°c%dClan2: °c%d%s°c%d has °c3left°c16 the clan.",
            xID,
            get_char_clan(cn),
            16, //internal clan color
            2,  //turn name green
        ...
        sprintf(buf,"%010u:%02u:°c%dClan2: °c%d%s°c%d has been °c3fired°c16 from the clan! Shame!",
            xID,
            get_char_clan(cn),
            16, //internal clan color
            2,  //turn name green
